...
replace (
	cosmossdk.io/x/evidence => cosmossdk.io/x/evidence v0.0.0-20230127204439-d3c319418514
	cosmossdk.io/x/feegrant => cosmossdk.io/x/feegrant v0.0.0-20230127204439-d3c319418514
	cosmossdk.io/x/nft => cosmossdk.io/x/nft v0.0.0-20230127204439-d3c319418514
	cosmossdk.io/x/upgrade => cosmossdk.io/x/upgrade v0.0.0-20230127204439-d3c319418514
)
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/cosmos/cosmos-sdk v0.46.0-beta2.0.20230127204439-d3c319418514
