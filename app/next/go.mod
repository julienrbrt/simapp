...
replace (
	cosmossdk.io/tools/rosetta => cosmossdk.io/tools/rosetta v0.2.1-0.20230205135133-41a3dfeced29
	github.com/cometbft/cometbft => github.com/cometbft/cometbft v0.0.0-20230203130311-387422ac220d
)

// TODO tag all extracted modules after SDK refactor
replace (
	cosmossdk.io/x/evidence => cosmossdk.io/x/evidence v0.0.0-20230205135133-41a3dfeced29
	cosmossdk.io/x/feegrant => cosmossdk.io/x/feegrant v0.0.0-20230205135133-41a3dfeced29
	cosmossdk.io/x/nft => cosmossdk.io/x/nft v0.0.0-20230205135133-41a3dfeced29
	cosmossdk.io/x/upgrade => cosmossdk.io/x/upgrade v0.0.0-20230205135133-41a3dfeced29
)
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/cosmos/cosmos-sdk v0.46.0-beta2.0.20230205135133-41a3dfeced29
